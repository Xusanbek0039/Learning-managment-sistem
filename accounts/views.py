...
def custom_logout(request):
    logout(request)
    return redirect('home')  # Chiqishdan keyin qaysi sahifaga yo'naltirish kerakligini ko'rsating
...
def register(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.error(
                request, "Nimadir to'g'ri emas, iltimos barcha maydonlarni to'g'ri to'ldiring."
            )
    else:
        form = StudentAddForm(request.POST)
...
def profile_single(request, id):
    """Tanlangan foydalanuvchi profilini ko'rsatish"""
...
def profile_update(request):
    ...
    return render(
        ...
        {
            "title": "Sozlamalar | IT Creative LMS",
            "form": form,
        },
    )
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                ...
                + " "
                + last_name
                + " uchun akkaunt yaratildi.",
            )
            return redirect("lecturer_list")
    else:
        form = StaffAddForm()
    context = {
        "title": "O'qituvchi qo'shish | IT Creative LMS",
        "form": form,
    }
...
def edit_staff(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            messages.success(request, "O'qituvchi " + full_name + " ma'lumotlari yangilandi.")
            return redirect("lecturer_list")
        else:
            messages.error(request, "Iltimos, quyidagi xatolikni to'g'rilang.")
    else:
    ...
    return render(
        ...
        {
            "title": "O'qituvchi tahrirlash | IT Creative LMS",
            "form": form,
        },
    )
...
class LecturerListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["title"] = "O'qituvchilar | IT Creative LMS"
        return context
...
def student_add_view(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                first_name + " " + last_name + " uchun akkaunt yaratildi.",
            )
            return redirect("student_list")
        else:
            messages.error(request, "Xatolikni to'g'rilang.")
    else:
        form = StudentAddForm()
    return render(
        request,
        "accounts/add_student.html",
        {"title": "Talaba qo'shish | IT Creative LMS", "form": form},
    )
...
def edit_student(request, pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            form.save()
            messages.success(request, ("Talaba " + full_name + " ma'lumotlari yangilandi."))
            return redirect("student_list")
        else:
            messages.error(request, "Iltimos, quyidagi xatolikni to'g'rilang.")
    else:
    ...
    return render(
        ...
        {
            "title": "Profil tahrirlash | IT Creative LMS",
            "form": form,
        },
    )
...
class StudentListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Talabalar | IT Creative LMS"
        return context
...
def staff_add_view(request):
    ...
    context = {
        "title": "Lecturer Add | IT Creative LMS",
        "form": form,
    }
...
def edit_staff(request, pk):
    ...
    return render(
        ...
        "accounts/edit_lecturer.html",
        {
            "title": "Edit Lecturer | IT Creative LMS",
            "form": form,
        },
    )
...
class LecturerListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Lecturers | IT Creative LMS"
        return context
...
def student_add_view(request):
    ...
    return render(
        request,
        "accounts/add_student.html",
        {"title": "Add Student | IT Creative LMS", "form": form},
    )
...
def edit_student(request, pk):
    ...
    return render(
        ...
        "accounts/edit_student.html",
        {
            "title": "Edit-profile | IT Creative LMS",
            "form": form,
        },
    )
...
class StudentListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Students | IT Creative LMS"
        return context
