...
BACHELOR_DEGREE = "Bakalavr"
MASTER_DEGREE = "Magistr"

DARAJALAR = (
    # (LEVEL_COURSE, "Level course"),
    (BACHELOR_DEGREE, "Bakalavr Darajasi"),
    (MASTER_DEGREE, "Magistr Darajasi"),
)
...
class Course(models.Model):
    ...
    level = models.CharField(max_length=25, choices=DARAJALAR, null=True)
    year = models.IntegerField(choices=YILLAR, default=0)
    semester = models.CharField(choices=SEMESTR, max_length=200)
...
class CourseOffer(models.Model):
    """Eslatma: Faqat kafedra boshlig'i semestr kurslarini taklif qilishi mumkin"""
